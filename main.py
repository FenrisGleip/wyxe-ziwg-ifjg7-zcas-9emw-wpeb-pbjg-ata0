...
RSS_FEEDS = {
    "MALWARE": [
        "https://feeds.feedburner.com/MalwarebytesUnpacked",          # Malwarebytes Labs
        "https://www.bleepingcomputer.com/feed/",                      # Bleeping Computer
        "https://isc.sans.edu/rssfeed_full.xml",                      # SANS ISC
        "https://feeds.trendmicro.com/Anti-MalwareBlog",              # Trend Micro
        "https://blog.malwarebytes.com/feed/",                        # Malwarebytes Blog
    ],
    "INITIAL": [
        "https://www.exploit-db.com/rss.xml",                         # Exploit-DB 新着PoC
        "https://nvd.nist.gov/feeds/json/cve/1.1/nvdcve-1.1-recent.json",  # NVD (handled separately)
        "https://feeds.feedburner.com/TheHackersNews",                # The Hacker News
        "https://packetstormsecurity.com/headlines.xml",              # Packet Storm
        "https://seclists.org/rss/fulldisclosure.rss",                # Full Disclosure
    ],
    "POST_EXP": [
        "https://www.bleepingcomputer.com/feed/",                     # Bleeping Computer
        "https://research.checkpoint.com/feed/",                      # Check Point Research
        "https://decoded.avast.io/feed/",                             # Avast Decoded
        "https://securelist.com/feed/",                               # Kaspersky Securelist
        "https://www.elastic.co/security-labs/rss/feed.xml",         # Elastic Security Labs
    ],
    "AI_SEC": [
        "https://embracethered.com/blog/rss.xml",                     # Embrace The Red (AI sec専門・prompt injection)
        "https://blog.trailofbits.com/feed/",                         # Trail of Bits (MCP/ツールセキュリティ)
        "https://simonwillison.net/atom/everything/",                 # Simon Willison (LLM sec・MCP動向)
        "https://arxiv.org/rss/cs.CR",                                # arXiv CS.CR (最新セキュリティ論文)
        "https://research.checkpoint.com/feed/",                      # Check Point Research
    ],
}
