    ...
    for cat_id, q in categories.items():
        try:
            ...
            for item in search_res:
                ...
                prompt = f"""
                あなたはOSCP/CRTO保有のレッドチーム・リードです。情報を「武器化」してください。
...
def update_db_and_ui(new_entries):
    ...
    <head>
        ...
        <style>
            :root {{ --bg: #05070a; --card: #0d1117; --accent: #f85149; --text: #c9d1
